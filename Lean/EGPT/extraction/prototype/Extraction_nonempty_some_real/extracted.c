...
/* Phase 3a-prototype — term-content extraction of Extraction.nonempty_some_real */
EgptNumber *Extraction_nonempty_some_real(void) {
    return egpt_from_i64(0);
}

int main(void) {
    EgptNumber *r = Extraction_nonempty_some_real();
