...
/* Phase 3a-prototype — term-content extraction of Extraction.decide_two_lt_three */
EgptNumber *Extraction_decide_two_lt_three(void) {
    return ((egpt_cmp(egpt_from_i64(2), egpt_from_i64(3)) == -1) ? egpt_from_i64(1) : egpt_from_i64(0));
}

int main(void) {
    EgptNumber *r = Extraction_decide_two_lt_three();
