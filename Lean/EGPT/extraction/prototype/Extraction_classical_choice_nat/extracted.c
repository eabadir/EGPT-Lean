...
/* Phase 3a-prototype — term-content extraction of Extraction.classical_choice_nat */
EgptNumber *Extraction_classical_choice_nat(void) {
    return egpt_from_i64(0);
}

int main(void) {
    EgptNumber *r = Extraction_classical_choice_nat();
